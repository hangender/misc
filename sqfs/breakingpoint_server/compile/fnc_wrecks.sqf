...
switch (_vehicleloottype) do {
	case "Military": {
		...
		_itemChance = [0.15, 0.15, 0.11, 0.12, 0.12, 0.15, 0.11, 0.18, 0.15, 0.15, 0.11, 0.11, 0.11, 0.12, 0.11, 0.15, 0.18, 0.11, 0.14, 0.12, 0.11, 0.16, 0.11, 0.11, 0.11, 0.25, 0.16, 0.14, 0.12, 0.11, 1.0, 2.5, 0.15, 0.12];
	};
	case "Residential": {
		...
		_itemChance = [0.10, 0.15, 0.15, 0.13, 0.13, 0.15, 0.13, 0.18, 0.16, 2, 0.16, 0.14, 0.11, 0.13, 0.13, 0.11, 0.11, 0.13, 0.15, 0.11, 0.16, 0.16, 0.11, 0.11, 0.18, 0.13];
	};	
	case "Industrial": {
