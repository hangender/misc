private ["_characterID","_doLoop","_playerID","_playerObj","_randomSpot","_primary","_key","_worldspace","_score","_position","_medical","_stats","_state","_dummy","_debug","_distance","_hit","_fractures","_humanity","_clientID"];//Set Variables
...
//dayzHit = ["dayzPlayerLogin2",_worldspace,_state];
//_clientID = owner _playerObj;
//_clientID publicVariableClient "dayzHit";
