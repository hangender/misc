...
server_udalitObj = 				compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\server_udalitObj.sqf";		//Creates the object in DB
...
ARGT_DEFENCE_POSITION = {
 //diag_log ("ARGT_DEFENCE_POSITION start");
...
ARGT_DEFENCE_DOORS = {
	//diag_log ("ARGT_DEFENCE_DOORS start");
...
ARGT_DEFENCE_PATROL = {
	//diag_log ("ARGT_DEFENCE_PATROL start");
...
ARGT_DEFENCE_CHICKEN = {
	//diag_log ("ARGT_DEFENCE_CHICKEN start");
...
ARGT_DEFENCE_SCAN = {
	//diag_log ("ARGT_DEFENCE_SCAN start");
  ...
  diag_log format ["r=%1",_result];
  _result
};

ARGT_DEFENCE_COLLECTION = {
	//diag_log ("ARGT_DEFENCE_COLLECTION start");
...
ARGT_DEFENCE_BEHAVIOUR = {
	//diag_log ("ARGT_DEFENCE_BEHAVIOUR start");
  private ["_unit"];
  _unit = _this select 0;
  while { alive _unit } do {
...
ARGT_DEFENCE_ESCAPE = {
	//diag_log ("ARGT_DEFENCE_ESCAPE start");
...
ARGT_DEFENCE_DIR = {
	//diag_log ("ARGT_DEFENCE_DIR start");
...
ARGT_DEFENCE_STOP = {
	//diag_log ("ARGT_DEFENCE_STOP start");
  private ["_unit"];
  _unit = _this select 0;
  waituntil {
    _unit forcespeed 0;
...
ARGT_DEFENCE_DAMAGE = {
	//diag_log ("ARGT_DEFENCE_DAMAGE start");
...
ARGT_DEFENCE_FIREDNEAR = {
	//diag_log ("ARGT_DEFENCE_FIREDNEAR start");
