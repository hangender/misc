#line 1 "z\addons\deathly_breakingpoint_server\init\publicEH_server.sqf"




"dayzLogin"			addPublicVariableEventHandler {_id = (_this select 1) spawn BPServer_LoginQueueAdd};
...
"HCLogin"			addPublicVariableEventHandler {_id = (_this select 1) spawn server_onHCConnected};
