...
call compile preProcessFileLineNumbers "\z\deathlyrage\breakingpoint_server\objects\ChernExtra11.sqf";
call compile preProcessFileLineNumbers "\z\deathlyrage\breakingpoint_server\objects\FavoldCas.sqf";
