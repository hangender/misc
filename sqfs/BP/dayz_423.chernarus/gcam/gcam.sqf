private ["_o","_o_l","_li_ol","_oc","_md","_mu","_cs_bdtime","_cs_m","_ocl","_mbld","_aczm","_zm","_cfzm","_dr","_dv","_acdv","_mm","_acm","_acdr","_kd","_ku","_kt","_k","_acx","_acy","_acz","_be_cods_t","_be_codr_a","_be_codv_t","_be_cdr_d","_cy_n","_cgk","_cy_sn","_nvg","_vm","_li","_lsc","_og","_help","_listopening","_ma_md","_ma_pm","_ma_pb","_ma_pd","_ma_dr","_ma_mu","_ma_p","_mapsize","_ma_ol","_ma_st","_ma_sc","_ocm","_ma_m","_ma_t","_ma_crp","_ma_mn","_ma_op","_ma_mnl","_ma_c","_quit","_quitchk","_l","_cfalt","_lostchk","_be_cftn","_be_odr","_be_codr_t","_be_codr","_be_codr_d","_be_codv_c","_be_odv_mx","_cp_r","_be_cdr_a","_be_cdr_t","_be_crt","_be_cods","_be_codv","_be_codv_d","_be_odv","_be_codv_r","_be_cdv_a","_fc_codr","_fc_codr_d","_fc_cdr_a","_fc_crt","_fc_op","_fc_cp","_fc_cods","_fc_codv","_fc_codv_d","_fc_cdv_a","_op","_wl","_cp","_w","_helptext","_c","_initobject","_initcamview","_initacctime","_initteamswitch","_be","_fo","_fc","_trg","_ehid_keydown","_ehid_keyup","_ehid_mousemove","_ehid_mousezchange","_ehid_mousebd","_ehid_mousebu","_kte","_ma_gu","_ma_cf","_ma_gmnl","_tx_addspace","_tx_crewname","_ol","_so_g","_so_gc","_so_matchobj","_so_o","_so_firstunit_chkd","_y","_z","_cy_ol_g","_cy_ol","_cy_vl","_cy_i","_li_cnt","_li_sg","_sm_l","_sm_n","_sm_d","_sm_cp","_sm_op","_sm_cods","_sm_cods_h","_sm_crt","_sm_codv","_sm_dv_d","_sm_cp_t","_sm_cp_t_l","_re_camobjdir","_re_cp_r_l","_fo_objdir","_fo_cods","_fo_cods_z","_fo_camobjdis_last","_fo_camobjdive_last","_fo_camdir_add","_fo_camobjdir_rel_last","_fo_dir_last","_fo_dive_last","_be_ofz","_fc_odr","_cs_ol","_cs_op","_cs_sp","_cs_sds","_cs_change","_cs_ha","_cs_cfha","_cs_hit","_cs_crz","_cs_crt","_cs_ct","_cs_c","_cs_l","_tr_ehidx","_tr_ehidx2","_tr_chase","_cm_o","_cm_op","_cm_cp","_cm_cp_r","_cm_l","_cm_rcvacctime","_cm_return","_cm_listshow","_cm_odv","_cm_odr","_cm_codv","_cm_codv_t","_cm_cods","_cm_codr","_cm_codr_a","_cm_codr_d","_cm_codr_t","_cm_cdr_a","_cm_cdr_d","_cm_cdr_t","_cm_cdv_a","_cm_cftn","_i","_OpenList","_CloseList","_ChangeModeFollow","_ChangeModeBehind","_ChangeModeFocus","_ChangeModeTrigger","_SetFiredHandler","_SelectObjects","_SelectCycleUnits","_SelectCycleLeaders","_tx_gn","_ListObjects","_CreateCameraMarker","_CreateGroupMarker","_CreateGroupMarker2","_CreateMapScanArea","_ClickSwitch","_SmoothMove","_ChaseMissile","_SwitchAdjustDistance","_ResetCamera"];
/*
					GCAM
		Modified By Deathlyrage for Breaking Point
*/
...
//if ((_uid) in BP_Spec_ID or _isAdmin) then
//{
