...
if (true) then
{
_this = createVehicle ["Land_Mil_ControlTower", [13067.721, 3647.5923, 4.2818656], [], 0, "CAN_COLLIDE"];
_vehicle_86 = _this;
...
if (true) then
{
_this = createVehicle ["Land_Mil_ControlTower", [13209.424, 3478.5696, 2.103996], [], 0, "CAN_COLLIDE"];
_vehicle_136 = _this;
